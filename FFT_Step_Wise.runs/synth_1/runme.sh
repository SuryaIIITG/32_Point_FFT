...
HD_PWD='C:/Users/surya/FFT_Step_Wise/FFT_Step_Wise.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FFT_32.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FFT_32.tcl
